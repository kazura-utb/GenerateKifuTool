...
BOOL OpenEvalData(char *filename)
{
	...
	while (cnt < 2)
	{
		...
		{
			/* horizon_ver1 */
			p_table = hori_ver1_data[cnt][stage];
			for (i = 0; i < 6561; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* horizon_ver2 */
			p_table = hori_ver2_data[cnt][stage];
			for (i = 0; i < 6561; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* horizon_ver3 */
			p_table = hori_ver3_data[cnt][stage];
			for (i = 0; i < 6561; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* diagram_ver1 */
			p_table = dia_ver1_data[cnt][stage];
			for (i = 0; i < 6561; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* diagram_ver2 */
			p_table = dia_ver2_data[cnt][stage];
			for (i = 0; i < 2187; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* diagram_ver3 */
			p_table = dia_ver3_data[cnt][stage];
			for (i = 0; i < 729; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* diagram_ver4 */
			p_table = dia_ver4_data[cnt][stage];
			for (i = 0; i < 243; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* corner5 + 2X */
			p_table = corner5_2_data[cnt][stage];
			for (i = 0; i < 59049; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* corner3_3 */
			p_table = corner3_3_data[cnt][stage];
			for (i = 0; i < 19683; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
			...
			/* triangle */
			p_table = triangle_data[cnt][stage];
			for (i = 0; i < 59049; i++)
			{
				p_table[i] = atof(line);
				line = strtok_s(NULL, "\n", &ctr);
...
#if 0
			/* mobility */
			p_table = mobility_data[cnt][stage];
